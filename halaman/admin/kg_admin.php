...
<body>
        ...
        <div class="container nav">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto gap-3">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active a1" aria-current="page" href="kg_admin.php">Kategori </a>
                    </li>
    ...
    <!-- produk -->
    <div class="list">
        <a href="tambah_kg.php" class="btn btn-primary" style="margin-left: 30px; ">Tambah Data Kategori</a>
        <table class="table">
            <thead>
                <tr>
                    <th scope="col">#</th>
