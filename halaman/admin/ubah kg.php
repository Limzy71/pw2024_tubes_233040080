...
$kategori = query("SELECT * FROM tb_kategori WHERE id_kategori = $id");
// var_dump($kategori);
  ...
  <div class="container col-6 tb">
    ...
    <form action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control" id="deskripsi" name="deskripsi" value="<?= $kategori['deskripsi']; ?>" required>
      </div>
      <div class="mb-3">
      ...
      <button type="submit" name="ubah2" class="btn btn-primary">Ubah data</button>
    </form>
  </div>
  <!-- tabel End -->
