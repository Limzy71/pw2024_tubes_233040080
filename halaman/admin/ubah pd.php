...
$produk = query("SELECT * FROM tb_produk WHERE id_produk = $id");
  ...
  <div class="container col-6 tb">
    ...
    <form action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control" id="deskripsi2" name="deskripsi2" value="<?= $produk['deskripsi_2']; ?>" required>
      </div>
      <div class="mb-3">
